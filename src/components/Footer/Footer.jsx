...
function Footer() {
    return(
        <>
        <div className="bg-gray-900 text-gray-100 p-3">
...
<h3 className="text-[120%] font-bold px-1 pt-3">دسترسی سریع</h3>
            <ul>
                ...
                <li><a href="">پیگیری شکایات</a></li>
                <li><a href="">شرایط قوانین فروشگاه</a></li>
            </ul>
...
<div><p>تماس با فروشگاه
    <br></br>
    09399619640</p></div>

            <div>
                <p>تماس با واحد پشتیبانی
                    <br></br>
                    061 4444444
                    <br />
                    061 4444444
