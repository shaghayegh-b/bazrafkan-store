    ...
    <Support></Support>
     <div className="h-12"></div>
        <div className="p-3">
            ...
            <h3 className="text-[120%] font-bold text-gray-100 px-1 pt-4">پشتیبانی:</h3>
            <p>فقط از طریق پیام رسان های
                 (تلگرام , واتس اپ , ایتا):09399619640
                 </p>
                 <h3 className="text-[120%] font-bold text-gray-100 px-1 pt-4">کانال ها:</h3>
                 <p>کانال ما در ایتا و تلگرام:@shaghayegh</p>
                 <h3 className="text-[120%] font-bold text-gray-100 px-1 pt-4">ادمین ثبت سفارش:</h3>
